...
1. <style="color:green">loop through end-points</>
1. define time/place search window
1. identify start-points
1. combine tracklets
1. repeat at step 1.
...
``` {r example3, eval=TRUE, echo=FALSE, fig.width=20}
...
---
# Ending
- code works (hopefully)
- next up: systematic testing

```{r ending, eval=TRUE, echo=FALSE, fig.width=7, fig.align = 'left'}
